...
import { getEUBillingAddress, getKlarnaUpdateSessionParams, getKlarnaUpdateSessionParamsPhone, getEUBillingAddressWithNoPhone } from './klarna.mock';
...
describe('KlarnaPaymentStrategy', () => {
    ...
    describe('#initialize()', () => {
        ...
        it('loads widget in EU', async () => {
            ...
            expect(klarnaCredit.load)
                .toHaveBeenCalledWith({ container: '#container' }, getKlarnaUpdateSessionParamsPhone(), expect.any(Function));
        });
